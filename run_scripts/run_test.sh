...
echo "----------------"
bash katalon-execute.sh -executionProfile="default" -browserType="Chrome" -retry=0 -testSuitePath="Test Suites/API/datachallenge-backend" -apiKey="8af2e205-6a35-4819-8fb2-452c8f3c5604"
